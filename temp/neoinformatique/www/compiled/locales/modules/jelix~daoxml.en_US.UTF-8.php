<?php $_loaded= array (
  ...
  'primarykey.missing' => '(523)DAO %1$s, primary key name is missing (file %2$s)',
  ...
  'method.values.property.unknown' => '(554)DAO %1$s, method %3$s,  unknown property on a <value> tag (file %2$s)',
  ...
  'method.condition.driver.notallowed' => '(561)DAO %1$s, method %3$, the driver of the database used here is not allowed accordind to the definition of the condition (file %2$s)',
  'method.orderitem.parameter.unknown' => '(563)DAO %1$s, method %3$,  unknown parameter %4$s in the orderitem tag (file %2$s)',
