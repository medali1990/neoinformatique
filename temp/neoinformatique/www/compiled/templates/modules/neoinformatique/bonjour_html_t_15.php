...
filemtime('C:\wamp2\www\jelix\neoinformatique/modules/neoinformatique/templates/bonjour.tpl') > 1443817155){ return false;
} else {
 require_once('C:\wamp2\www\jelix\lib\jelix/plugins/tpl/html/function.jurl.php');
function template_meta_842f61f5944d6908f9cf34a8e539cc7e($t){

}
function template_842f61f5944d6908f9cf34a8e539cc7e($t){
?>
<body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="<?php jtpl_function_html_jurl( $t,'neoinformatique~default:index');?>">Home</a></li>
            <li><a href="<?php jtpl_function_html_jurl( $t,'neoinformatique~admin:form_create');?>">Creation formulaire</a></li>
