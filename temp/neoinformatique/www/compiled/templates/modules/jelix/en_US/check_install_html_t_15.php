...
filemtime('C:\wamp2\www\jelix\lib\jelix/core-modules/jelix/templates/en_US/check_install.tpl') > 1424786578){ return false;
} else {
 require_once('C:\wamp2\www\jelix\lib\jelix/plugins/tpl/html/meta.html.php');
function template_meta_e3fbaf8404ba3e91691665ab169c064c($t){
jtpl_meta_html_html( $t,'css',$t->_vars['j_jelixwww'].'design/jelix.css');

}
function template_e3fbaf8404ba3e91691665ab169c064c($t){
?>

<div id="page">
    <div class="logo">Powered by <img src="<?php echo $t->_vars['j_jelixwww']; ?>design/images/logo_jelix_100.png" alt="Jelix"/></div>
    ...
    <div class="nocss">
        ...
        <ul>
            <li>You can configure your virtualhost to create an alias
                <em><?php echo $t->_vars['j_basepath']; ?>jelix/</em> to <em>lib/jelix-www/</em></li>
            <li>Otherwise copy/past the <em>lib/jelix-www/</em> directory in
                <em><?php echo $t->_vars['wwwpath']; ?></em> and rename it to 'jelix'</li>
        </ul>
        <p>If you want to use another name for the Jelix's web file directory,
            modify the <code>jelixWWWPath</code> parameter in
            <em><?php echo $t->_vars['configpath']; ?>defaultconfig.ini.php</em>.</p>
